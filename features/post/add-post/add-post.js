...
import { addPost } from "@/features/post/add-post/add-post.actions";
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
          ...
          <div className="grid w-full gap-1.5">
            ...
            <Textarea id="body" name="body" placeholder="Write the content of your post here..." className="h-60" required />
          </div>
          {error && <p className="text-red-500">{error}</p>}
          <div className="flex justify-end w-full gap-1.5">
            <Button variant="secondary" asChild>
              <Link href="/posts" className="w-32">Cancel</Link>
            </Button>
